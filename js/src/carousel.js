...
const Carousel = (($) => {
  ...
  class Carousel {
    ...
    static _dataApiClickHandler(event) {
      ...
      const config     = Util.extend(Util.extend({}, Data.getData(target, DATA_KEY)), Util.getDataAttributes(this))
  ...
  EventHandler.on(window, Event.LOAD_DATA_API, () => {
    ...
    for (let i = 0; i < carousels.length; i++) {
      ...
      Carousel._jQueryInterface.call($carousel, Data.getData(this, DATA_KEY))
    }
  })
